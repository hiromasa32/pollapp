...
// 必ず同じDBへのコネクション（同じインスタンス）を取得する
#[\AllowDynamicProperties]
class PDOSingleton {
    private static $singleton;      // DBへのコネクションが保持される
...
class DataSource {
    ...
    public function __construct($host = 'mysql1.php.xdomain.ne.jp', $port = '3306', $dbName = 'kunren0622_pollapp', $username = 'kunren0622_test', $password = 'Eg6bnGZd') {
